...
import { ResetMethod, ResetStep } from "./types";
import ResetPasswordRequestStep from "./ResetPasswordRequestStep";
import ResetPasswordOtpStep from "./ResetPasswordOtpStep";
import ResetPasswordNewStep from "./ResetPasswordNewStep";
import ResetPasswordSuccessStep from "./ResetPasswordSuccessStep";
import {
...
export default function ResetPasswordForm() {
  ...
  const handleSendCode = (e: React.FormEvent) => {
    ...
    if (!result.success) {
      ...
      setError(firstError?.message || "驗證失敗");
      return;
    }
  ...
  const handleResetPassword = (
    ...
    const result = resetPasswordNewSchema.safeParse({
      newPassword,
      confirmPassword,
    });
    if (!result.success) {
