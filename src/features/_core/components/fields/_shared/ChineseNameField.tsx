...
export interface ChineseNameFieldProps extends FieldProps<string> {}
 ...
 *   label="中文姓名"
 *   required
 *   error={errors.nameChinese?.message}
 * />
 * ```
 */
export const ChineseNameField = memo(function ChineseNameField({
  // 1️⃣ 數據
  value,
  onChange,
  // 2️⃣ 顯示模式
